        ...
        <div>
          <div className="Card">
            <div className="childCard"> 
                      <div className="saharaImg" ><div className="date">27 <span className="mar">MAR</span></div><button className="photobtn">PHOTOS</button></div>
                      ...
                      <div className="icons">o 6 mins ago<span className="comments"><img className="commentIcon" src="./src/comments-solid.svg" />39 comments</span></div>
            </div>
          </div>
        </div>
      );
